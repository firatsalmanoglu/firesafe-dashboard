...
const renderRow = (item: CustomerList) => (
  <tr
    key={item.id}
...
const CustomerListPage = async ({
  ...
  const query: Prisma.CustomersWhereInput = {}; // Prisma için boş bir query nesnesi oluşturuluyor.
    ...
    return (
        <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
            ...
            <div className='flex item-center justify-between'>
                <h1 className="hidden md:block text-lg font-semibold">Tüm Müşteriler</h1>
