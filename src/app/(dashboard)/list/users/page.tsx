    ...
    >
        ...
        <td className="flex items-center gap-4 p-4">
            ...
            <div className="flex flex-col">
                ...
                <p className="text-xs text-gray-500">{item.institution ? item.institution.name : "Kurum Bilgisi Yok"}</p>
            </div>
        </td>
        <td className="hidden md:table-cell">{item.role ? item.role.name : "Rol Bilgisi Yok"}</td>
